...
class District(models.Model):
    ...
    district_name =  models.CharField(max_length=255, verbose_name=_("District"))
...
class County(models.Model):
    ...
    county_name = models.CharField(max_length=255, verbose_name=_("County"))

#model for PostalCode(códigos_postais.csv from ctt)
class PostalCode(models.Model):
    district_name = models.CharField(max_length=255, verbose_name=_('District'),blank=True, null=True)
    county_name = models.CharField(max_length=255, verbose_name=_('County'), blank=True, null=True)

    county_code = models.CharField(max_length=10, verbose_name=_("County code"), db_index=True)
    district_code = models.CharField(max_length=10, verbose_name=_("District code"), db_index=True)
    country_name = models.CharField(max_length=20, verbose_name=_("Country"), blank=True, null=False)
    locality_name = models.CharField(max_length=125, verbose_name=_("Locality"),blank=True, null=False)
    ...
    postal_code = models.IntegerField(verbose_name=_("Postal Code"), help_text='cp4',blank=True, null=False, db_index=True)
    postal_code_extension = models.IntegerField(verbose_name=_("Postal Code Extension"), help_text='cp3',blank=True, null=False, db_index=True)
